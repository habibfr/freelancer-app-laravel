    ...
    <main class="h-full overflow-y-auto">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a class="font-medium">Add Your Service</a>
                </li>
            </ol>
        </nav>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option value="5"> 4 Revisi</option>
                                                <option value="7"> 8 Revisi</option>
                                                <option value="10"> 16 Revisi</option>
                                                <option value="12"> 32 Revisi</option>
                                            </select>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @if ($errors->has('price'))
                                                <p class="text-red-500 mb-3 text-sm">{{ $errors->first('price') }}
                                                </p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Thumbnail 1" type="file" name="thumbnail[]"
                                                id="thumbnail1" autocomplete="thumbnail1"
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Catatan" type="text" name="tagline[]" id="tagline" autocomplete="service-name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan 3" type="file" name="thumbnail[]" id="thumbnail1" autocomplete="service-name" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
