                                    ...
                                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                        ...
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                ...
                                                @forelse ($thumbnail as $thumbnail_item)
                                                    <img :class="{
                                                        'border-4 border-serv-button': active ===
                                                            {{ $thumbnail_item->id }}
                                                    }"
                                                        @click="changeThumbnail('{{ url(Storage::url($thumbnail_item->thumbnail)) }}', {{ $thumbnail_item->id }})"
                                                        :src="`{{ url(Storage::url($thumbnail_item->thumbnail)) }}`"
                                                        alt="thumbnail"
                                                        class="inline-block mr-2 rounded-lg cursor-pointer w-24">
                                        ...
                                        <div>
                                            ...
                                            <div class="leading-8 text-md">
                                                ...
                                                <ul class="mb-4 list-check">
                                                    ...
                                                    @forelse ($advantage_service as $key => $advantage_service_item)
                                                        <li class="pl-10 my-2">
