                                    ...
                                    <td class="px-1 py-5 text-sm w-2/8">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-400">
                                                    {{ $orde->order_buyer->detail_user->contact_number ?? '' }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <div class="relative mt-0 md:mt-6">
                                        ...
                                        @if (isset($order->file))
                                            <a href="{{ url(Storage::url($order->file ?? '')) }}"
                                                ...
                                                onclick="confirm('Are you sure to download this file ?')">
                                                Download File
                                            </a>
                                        @else
                                            <label for="choose"
                            ...
                            <div class="">
                                <div class="p-1 mt-5">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="note" id="note" autocomplete="note"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                rows="4" required {{ isset($order->file) ? 'disabled' : '' }}>{{ $order->note ?? '' }}</textarea>
                                ...
                                <div class="px-1 py-4 text-right">
                                    <a href="{{ route('member.order.index') }}" type="button"
                                        ...
                                        onclick="confirm('Are you sure want to back? any changes will not be save!')">
                                        Back
                                    </a>
                                    ...
                                    @if (isset($order->file) == false)
                                        <button type="submit"
                                            ...
                                            onclick="confirm('Are you sure to submit this data!')">
                                            Approve
                                        </button>
                                    @else
                                        <button type="submit"
