...
Route::group(
    ...
    function () {
        ...
        // service
        // Route::put('member/service/{id}/updatebro', [ServiceController::class, 'update'])->name("service.updatebro");
        ...
        // Route::put('member/order/{id}/edit/uptd', [ServiceController::class, 'update'])->name("service.updatebro");
